...
/**
 * @def CMD_PLAYMP3FOLDER
 * @brief Play a track within the "mp3" folder. Filename format: ####XXXX.mp3
 */
...
/**
 * @brief Plays a specific track from the "mp3" folder.
 *
 * @param dfplayer The DFPlayer instance to play the track on.
 * @param track The track ID to play from the "mp3" folder.
 */
void dfplayer_play_mp3_folder(dfplayer_t *dfplayer, uint16_t track);
