#ifndef MIL_ELECTRICAL_PROTOCOL_MSG_H_
#define MIL_ELECTRICAL_PROTOCOL_MSG_H_
...
/**
 * @brief Function to parse and validates a message that was received
 * 
...
/**
 *  @brief Function that sends the raw values of the message through USB UART
 *
...
#endif // MIL_ELECTRICAL_PROTOCOL_MSG_H_
